            ...
            <tr>
              <td valign="top" class="em_aside">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    <td align="center" style="font-family:'Open Sans', Arial, sans-serif; font-size:16px; line-height:19px; color:#30373b;  font-weight:bold;"><span style="color:#feae39;">{{$name}}</span> hemos recibido tu solicitud de información, en breve uno de nuestros agentes se pondrá en contacto contigo, para brindarte información a detalle de tu interés...</td>
                  </tr>
                  <tr>
                    <td height="30" class="em_height">&nbsp;</td>
                  </tr>
