            ...
            <tr>
              <td valign="top" class="em_aside">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    <td align="center" style="font-family:'Open Sans', Arial, sans-serif; font-size:16px; line-height:19px; color:#30373b;  font-weight:bold;"><span style="color:#feae39;">{{$name}}</span> ha enviado el siguiente mensaje...</td>
                  </tr>
                  <tr>
                    <td height="30" class="em_height">&nbsp;</td>
                  </tr>
                        ...
                        <tr>
                          ...
                          <td align="center" valign="top">
                            <table width="100%" align="center" border="0" cellspacing="0" cellpadding="0">
                              ...
                              <tr>
                                <td  align="center"  style="font-family:'Open Sans', Arial, sans-serif; font-size:16px; line-height:24px; color:#ffffff; font-style:italic;">"{{$msj_send}}"</td>
                              </tr>
                              <tr>
                                <td align="center"  style="font-family:'Open Sans', Arial, sans-serif; font-size:16px; line-height:19px; color:#ffffff;  font-weight:bold;"></td>
                              </tr>
                              <tr>
                              ...
                              <tr>
                                <td align="center" valign="top">
                                  <table width="210" bgcolor="#ffffff" align="center" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                      <td height="60" align="center" valign="middle" style="font-family:'Open Sans', Arial, sans-serif; font-size:12px;color:#feae39; font-weight:bold;">{{$phone}}  {{$email}}</td>
                                    </tr>
                                  </table>
                                </td>
                              </tr>
